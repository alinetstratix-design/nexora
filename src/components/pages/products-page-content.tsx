      ...
      <section className="relative py-24 md:py-40 overflow-hidden nexora-gradient">
        ...
        <SectionWrapper className="relative z-10 text-center">
          ...
          <p className="max-w-2xl mx-auto text-white/80 text-lg md:text-xl font-medium tracking-tight leading-relaxed">
            Accelerate your workflow with our hand-crafted, high-performance templates and UI kits. Built by seniors, for the next generation of founders.
          </p>
        </SectionWrapper>
      </section>
        ...
        >
          {siteConfig.products.map((product) => (
            <motion.article key={product.id} variants={itemVariants}>
              <TiltCard className="rounded-[2.5rem] group h-full bg-brand-light border border-brand-border">
